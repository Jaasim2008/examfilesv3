			...
			<div class="accordion-content px-4" style="max-height: {openIndex === index ? 'full' : '0px'}; padding-top: {openIndex === index ? '1rem' : '0'}; padding-bottom: {openIndex === index ? '1rem' : '0'}">
				...
				{:else if index === 1}
					<p>
						...
						<a class="text-dark-primary underline" href="https://patreon.com/Jaasim?utm_medium=unknown&utm_source=join_link&utm_campaign=creatorshare_creator&utm_content=copyLink">support me</a> by the way.
					</p>
				{:else if index === 2}
