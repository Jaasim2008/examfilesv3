        ...
        <div class="h-[60vh] overflow-y-auto md:h-auto md:overflow-visible text-center">
            <table class="min-w-full table-auto border-collapse border border-gray-700 text-left">
                ...
                <tr class="text-sm md:text-base">
                    ...
                    <th class="sticky top-0 border border-gray-700 px-4 py-2 text-left bg-secondary text-white cursor-help" title="Question Paper">QP</th>
                    <th class="sticky top-0 border border-gray-700 px-4 py-2 text-left bg-secondary text-white cursor-help" title="Marking Scheme">MS</th>
                </tr>
                </thead>
                <tbody>
                    {#each files as file}
